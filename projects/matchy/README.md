...
## Step 2 - Array Creation
 ...
 2. [1 ] Using **bracket notation** give `noises` it's first element. A string representing a sound your animal might make.
 3. [2 ] Using an array function add another noise to the end of `noises`.
 ...
 6. [3 ] Add an element to `noises` using this function.
 7. [4 ] Using **bracket syntax** again, add another element to the end of `noises`. Make sure that the way you do this step would work no matter how many elements `noises` had. In other words, don't hard code the position of the new element.
