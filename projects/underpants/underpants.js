...
_.partition = function(array, fun) {
    const filterArray = _.filter(array, function(value, index, collection) {
        return fun(value, index, collection);
    });
    const rejectArray = _.reject(array, function(value, index, collection) {
        return fun(value, index, collection);
    });
...
_.every = function(collection, fun) {
    ...
    if (fun !== undefined) {
        _.each(collection, function(value, index, collection) {
            let every = fun(value, index, collection);
